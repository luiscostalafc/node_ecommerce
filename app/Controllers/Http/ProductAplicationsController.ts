...
import ProductAplicationValidator from 'App/Validators/ProductAplicationValidator'

export default class ProductAplicationsController {
  protected repository
  protected validator
  constructor (repository: ProductAplicationsRepository, validator: ProductAplicationValidator) {
