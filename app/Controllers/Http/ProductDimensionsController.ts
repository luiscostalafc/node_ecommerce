...
import ProductDimensionsRepository from 'App/Repositories/ProductDimensionsRepository'
import { ProductDimensionSchema } from 'App/Validators'

export default class ProductDimensionsController {
  private readonly repository
  constructor () {
    this.repository = ProductDimensionsRepository
  }
  ...
  async store ({ request, response }: HttpContextContract) {
    try {
      await request.validate({schema: ProductDimensionSchema})
    } catch (error) {
